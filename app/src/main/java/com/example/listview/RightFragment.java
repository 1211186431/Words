...
public class RightFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View contentView = inflater.inflate(R.layout.fragment_right, container, false);
        WordsDB wordsDB=new WordsDB(contentView.getContext());
        Words.WordDescription wordDescription=wordsDB.getSingleWord(id);
        TextView textView1 = contentView.findViewById(R.id.right_name);
        textView1.setText(wordDescription.getWord());
        TextView textView2 = contentView.findViewById(R.id.right_meaning);
        textView2.setText(wordDescription.getMeaning());
        TextView textView3 = contentView.findViewById(R.id.right_sample);
